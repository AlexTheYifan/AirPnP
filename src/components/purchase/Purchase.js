...
class Purchase extends React.Component{
    render(){
        let pic = this.props.location.state.pic;
            ...
            <div class="row">
                ...
                <div class="col-25">
                    <div class="container" id="pic">
                        <span><img src={pic}  alt={name} style={{width: '100%'}} /></span>
                        <p>Item: <span class="cart">{name}</span></p>
                        <p>Price: <span class="cart">{price}</span></p>
                    </div>
                </div>
            </div>
        );
